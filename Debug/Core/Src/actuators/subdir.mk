...
CPP_SRCS += \
../Core/Src/actuators/blhelis.cpp 

OBJS += \
./Core/Src/actuators/blhelis.o 

CPP_DEPS += \
./Core/Src/actuators/blhelis.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/actuators/%.o Core/Src/actuators/%.su: ../Core/Src/actuators/%.cpp Core/Src/actuators/subdir.mk
...
clean: clean-Core-2f-Src-2f-actuators

clean-Core-2f-Src-2f-actuators:
	-$(RM) ./Core/Src/actuators/blhelis.d ./Core/Src/actuators/blhelis.o ./Core/Src/actuators/blhelis.su

.PHONY: clean-Core-2f-Src-2f-actuators
