...
CPP_SRCS += \
../Core/Src/state/trajectories.cpp 

OBJS += \
./Core/Src/state/trajectories.o 

CPP_DEPS += \
./Core/Src/state/trajectories.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/state/%.o Core/Src/state/%.su: ../Core/Src/state/%.cpp Core/Src/state/subdir.mk
...
clean-Core-2f-Src-2f-state:
	-$(RM) ./Core/Src/state/trajectories.d ./Core/Src/state/trajectories.o ./Core/Src/state/trajectories.su
