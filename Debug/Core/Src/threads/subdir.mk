...
clean-Core-2f-Src-2f-threads:
	-$(RM) ./Core/Src/threads/actuatorthread.d ./Core/Src/threads/actuatorthread.o ./Core/Src/threads/actuatorthread.su ./Core/Src/threads/controllerthread.d ./Core/Src/threads/controllerthread.o ./Core/Src/threads/controllerthread.su ./Core/Src/threads/estimatorthread.d ./Core/Src/threads/estimatorthread.o ./Core/Src/threads/estimatorthread.su ./Core/Src/threads/initializerthread.d ./Core/Src/threads/initializerthread.o ./Core/Src/threads/initializerthread.su ./Core/Src/threads/mutexes.d ./Core/Src/threads/mutexes.o ./Core/Src/threads/mutexes.su ./Core/Src/threads/sensorthread.d ./Core/Src/threads/sensorthread.o ./Core/Src/threads/sensorthread.su
